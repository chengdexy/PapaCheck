...
- `DATABASE_URL=postgresql://papacheck***REDACTED***@localhost:5432/papacheck_test`
...
- [ ] **Step 4: 运行全量测试（使用备份库）**
  ```bash
  $env:DATABASE_URL="postgresql://papacheck***REDACTED***@localhost:5432/papacheck_prod_verify"; npx vitest run
  ```
