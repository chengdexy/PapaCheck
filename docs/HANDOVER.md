...
# 方式二：手动指定
$env:DATABASE_URL="postgresql://papacheck:papacheck@localhost:5432/papacheck_test"; npx vitest run

# 方式三：持久化设置（一次设置，永久生效）
[System.Environment]::SetEnvironmentVariable('DATABASE_URL', 'postgresql://papacheck:papacheck@localhost:5432/papacheck_test', 'User')
```
