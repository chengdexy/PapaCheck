...
| 日期 | 变更 |
|------|------|
| 2026-06-08 | 新增回顾页（review.html）：滚动叙事战绩回顾，15屏全屏展示 22 天学习数据（112项作业/28.2h投入/81%优评/6,179积分），含 count-up 动画、snap 滚动、minimalist 视觉风格；配套数据提取脚本 gen_review_data.cjs |
