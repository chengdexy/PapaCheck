...
def restore_better_sqlite3():
    """SEA 构建将 better-sqlite3 编译为 Node 18 目标后，恢复为系统 Node 版本"""
    print('正在恢复 better-sqlite3 为系统 Node 版本...')
    ...
    if result.returncode != 0:
        print(f'[警告] better-sqlite3 恢复失败，可手动执行 npm rebuild better-sqlite3')
    else:
        print('better-sqlite3 已恢复为系统 Node 版本')
...
def main():
    ...
    # SEA 构建会将 better-sqlite3 编译为 Node 18 目标，立即恢复为系统 Node 版本
    restore_better_sqlite3()
